...
var isProbablyReaderable = __webpack_require__(896);
        ...
        try {
            ...
            for (const div of document.querySelectorAll("*")) {
                if (div.tagName === "H1" &&
                    ...
                    (_a = div.parentElement) === null || _a === void 0 ? void 0 : _a.append(div1);
                }
            }
        }
        finally {
            ...
            if (!spinner)
                return;
            (_b = spinner.parentNode) === null || _b === void 0 ? void 0 : _b.removeChild(spinner);
...
const fetchNews = (articleLink) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { Readability } = __webpack_require__(107);
    ...
    const res1 = yield fetch(backendURL + "/api/headlines/get-rhyming", {
        method: "POST",
        headers: {
    ...
    const rhymingHeadline = yield res1.json();
    const res2 = yield fetch(backendURL + "/api/bias", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            Authorization: "Bearer " + token.token,
    ...
    const biasSummary = yield res2.json();
    return {
        headline: news.headline,
...
const uploadNews = (news) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let res = yield fetch(backendURL + "/api/mongodb/push-user-news", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: "Bearer " + token.token,
        ...
        res = yield fetch(backendURL + "/api/mongodb/push-news", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: "Bearer " + token.token,
        ...
        res = yield fetch(backendURL + "/api/pinecone/upsert", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: "Bearer " + token.token,
